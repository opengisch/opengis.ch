...
![](./82cd1.png)Mit _Rechtsklick > Zoom auf Koordinate_ wird in der Karte auf die Koordinaten gezoomt und die Koordinate leuchtet auf.
Um Überschneidungen und Duplikate zu beheben kann das QGIS _Stützpunkwerkzeug_ verwendet werden. ![](./Screenshot-from-2022-11-08-14-14-5630db.png)Ebenso ist der _Stützpunkteditor_ sehr hilfreich.
![](./Screenshot-from-2022-11-07-17-14-022cd1.png)
### Durch die Fehler navigieren
Mit den drei Symbolen unten rechts, lässt es sich durch die Features und Koordinaten navigieren, wie du es dir schon von der Attributtabelle in der Formularansicht gewohnt bist. ![](./grafikfc12.png)
