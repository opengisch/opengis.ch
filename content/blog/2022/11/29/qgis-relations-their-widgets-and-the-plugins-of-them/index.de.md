...
url: "/de/2022/11/29/qgis-relations-their-widgets-and-the-plugins-of-them/"
source: "www.opengis.ch/de/2022/11/29/qgis-relations-their-widgets-and-the-plugins-of-them/index.html"
---
...
![UML diagram showing Building, Apartment, Address, and Owner relations](./erm7858.png)
...
![QGIS layer list with the relation example tables](./layers865a.png)
...
![Relation Editor creating apartments for the building Garden Tower](./relationeditorbdf7.png)
...
![Relation Editor widget settings in the QGIS attribute form](./relationeditor_settingsd74a.png)
...
![Relation Reference widget selecting a building for an apartment](./relationreferencebeea.png)
...
![Value Relation widget settings for the Building layer](./valuerelation_settingsf94b.png)
The result shows us a drop down as well to select the parent.
![Value Relation dropdown showing available parent features](./valuerelationdc74.png)
...
![Dialog for linking owners to an apartment](./linking_dialoga982.png)
...
![Relation Editor showing a many-to-many owner relation](./relationeditor_manybf6d.png)
...
![Join settings for the one-to-one Building and Address relation](./joins_settings7d63.png)
...
![Feature form with joined Address fields](./joinsfd6b.png)
...
![Linking Relation Editor widget moving features between linked and unlinked lists](./Peek-2022-11-25-13-5939b0.gif)
...
![Ordered Relation Editor widget reordering children by drag and drop](./Peek-2022-11-25-14-08-14aa7.gif)Find more information on the repository <https://github.com/opengisch/qgis-ordered-relation-editor>
...
![Polymorphic relation configuration for linked documents](./image-37c29.png)
...
![Document management widget showing linked documents](./Peek-2022-11-27-15-254aa7.gif)
...
![Document feature form showing links to related features](./Peek-2022-11-27-15-30-1cc52.gif)
