---
title: 'QField 2.4 is here, and it is ?icious – OPENGIS.ch'
date: 2022-10-13
slug: "qfield-2-4-is-here-and-it-is-🍏icious"
url: "/it/2022/10/13/qfield-2-4-is-here-and-it-is-🍏icious/"
source: "www.opengis.ch/it/2022/10/13/qfield-2-4-is-here-and-it-is-🍏icious/index.html"
---
Yes, QField for QGIS, the leading fieldwork app, was released on the iOS App Store!
> [![QField download badges for Android, iOS, macOS, Windows, and Linux](./stores26e7.png)](<https://qfield.org/get>)
...
![New QField demo projects, including bees and wastewater examples with light and dark themes](./qfield243066.png)_New demo projects showing many new QField features. We merged the Bee simple and Bee advanced projects into one bees project and added a wastewater management project that comes with beautiful dark and light themes._
...
![QField interface illustrating bugfixes and improved SVG rendering in the release](./image7ddf.png)
...
![QFieldCloud dashboard showing the stable, consistently green service status page](./image-3c738.png)
...
## Support QField
We put a lot of effort into ensuring that QField, is of the highest possible quality and invest a lot of developer time in QField, QFieldCloud and QGIS. Plenty of it is sponsored by OPENGIS.ch because we believe in giving back to the OS geo community; part is sponsored by the clients that ask us to [develop features](</sviluppo/index.html>), and part is financed through our [support contracts](</supporto-qgis/index.html>) that come with a [sustainability initiative](</la-nostra-iniziativa-di-sostenibilita-qgis/index.html>).
