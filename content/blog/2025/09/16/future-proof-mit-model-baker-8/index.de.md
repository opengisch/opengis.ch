...
![_Bild: Murphy / Zimmerman_](./deloreanc395.jpg)
...
![_Bild: Charles J. Sharp_](./imagefb82.jpg)
...
![Model Baker import prompt offering the standard wizard or the Quick Visualizer for an XTF file](./Screenshot-from-2025-09-02-15-16-1138f5.png)
...
![Quick Visualizer import dialog creating a temporary GeoPackage from the XTF file](./Screenshot-from-2025-09-02-15-16-4238f5.png)
...
![Imported hornet nest data displayed in QGIS after the Quick Visualizer run](./Screenshot-from-2025-09-02-15-17-4738f5.png)
...
![Model Baker import wizard page listing the same detected model multiple times before the UI cleanup](./image-3d81f.png)
...
![Collection of ILI, repository, catalog, transfer, and metaconfig sources loaded into QGIS for model detection](./image-4ecad.png)
...
![Model Baker UI after deduplicating detected models into a single consolidated list](./image-59d1c.png)
...
![Tooltip in Model Baker explaining which source contributed the detected model](./image-6cb4b.png)
...
![Model Baker settings dialog showing the ili2db dbparams configuration field](./image-7986a.png)
