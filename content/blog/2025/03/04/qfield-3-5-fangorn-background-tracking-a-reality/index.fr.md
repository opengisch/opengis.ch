...
url: "/fr/2025/03/04/qfield-3-5-fangorn-background-tracking-a-reality/"
source: "www.opengis.ch/fr/2025/03/04/qfield-3-5-fangorn-background-tracking-a-reality/index.html"
---
...
## Main highlights
![QField 3.5 splash screen announcing the Fangorn release and background tracking](./splash3aae.png)
...
![QGIS project settings dialog configuring grid decoration for display in QField](./griddialogf274.png)
...
![QField print-to-PDF template that works even when a project has no layouts defined](./alwayspdf17e4.png)
...
![QField plugin manager showing the new plugin configuration button interface](./configuration3801.png)
...
{{< blog-video src="https://videopress.com/embed/RqiQKWXY" title="VideoPress video" >}}
