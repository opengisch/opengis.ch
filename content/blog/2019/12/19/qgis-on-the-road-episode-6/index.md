...
url: "/2019/12/19/qgis-on-the-road-episode-6/"
source: "www.opengis.ch/2019/12/19/qgis-on-the-road-episode-6/index.html"
...
At [OPENGIS.ch](</new.opengis.ch/index.html>) we can help you set up your spatial data infrastructure based on seamlessly integrated desktop, web and mobile components. We [support](</qgis-support/index.html>) your team in [planning](</training-consulting/index.html>), [developing](</custom-development/index.html>), [deploying and running](</qgis-support/index.html>) your infrastructure. Thanks to several senior geodata infrastructure experts, QGIS core developers and the makers of [QField](<https://qfield.org/>), OPENGIS.ch has all it takes to make your project a success. OPENGIS.ch is known for its commitment to high-quality products and its [continuous efforts](</qgis-sustainability-initiative/index.html>) to improve the open source ecosystem.
### _Related_
