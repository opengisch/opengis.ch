...
class DependabotContractTests(unittest.TestCase):
    def test_dependabot_tracks_workflows_and_root_browser_audit_npm_manifest(self) -> None:
        ...
        self.assertNotIn('directory: "/themes/qfield-theme-v3"', config)
        ...
        self.assertNotIn("theme-build-tooling:", config)
